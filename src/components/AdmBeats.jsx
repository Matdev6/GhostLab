...
export default function AdmBeats() {
    ...
    return (
        <div className="sm:w-3/5 sm:h-[80vh] w-4/5 h-[70vh] m-4 sm:ml-2 bg-neutral-50 rounded-lg shadow-lg p-4 sm:mx-8 flex flex-col justify-between">
            <h1 className="text-center text-xl">Beats Não Exclusivos</h1>
