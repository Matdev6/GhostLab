    ...
    return (
        <div>
            <motion.a
                ...
                href={link}
                target="_blank"
                className=" w-3/4 md:w-2/4 mb-10 h-56 lg:w-80 lg:h-80 shadow-lg border border-fundo-secundario rounded-2xl p-4 flex flex-col items-center cursor-pointer">
